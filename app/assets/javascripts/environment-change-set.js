...
YUI.add('environment-change-set', function(Y) {
  ...
  ns.EnvironmentChangeSet = Y.Base.create(name, Y.Base, [], {
    ...
    */
    ...
    /**
      Creates a new record of the appropriate type in the pds.
    ...
    */
    ...
    /**
      ...
      @param {Object} command The individual command object from the pds.
    ...
    */
    _wrapCallback: function(command) {
      ...
      function callbackWrapper() {
        ...
        self.fire('commit', command);
      }
      config[index] = callbackWrapper;
      return command;
    },
    ...
    /**
      Executes all of the commands stored in the pds.

      @method commit
    */
    commit: function() {
      var pds = this.pds;
      Object.keys(pds).forEach(function(key) {
        pds[key].commands.forEach(function(command) {
