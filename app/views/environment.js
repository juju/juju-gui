...
var EnvironmentView = Y.Base.create('EnvironmentView', Y.View, [views.JujuBaseView], {
    ...
    render_canvas: function(){
        ...
        var services = m.services.toArray().map(function(s) {
            ...
            // Since we're drawing rects with the corner at (x, y), we can
            // easily correct for things being skewed using the radius
            // generated by tree.nodes()
            s._x = function() { return this.x - this.r; };
            s._y = function() { return this.y - this.r; };
            return s;
        });
