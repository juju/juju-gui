...
YUI.add('juju-topology-service', function(Y) {
   ...
   *                      process, when moving the cursor over the environment,
   *                      and when dropping the endpoint on a valid service.
   *  cancelRelationBuild: fired when dropping a pending relation line started
   *                       through the long-click method somewhere other than
   *                       a valid service.
