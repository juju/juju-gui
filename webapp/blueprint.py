...
@gui.route("/config.js")
def config():
    JAAS_API_BASE = os.environ.get("JAAS_API_BASE", default="https://api.jujucharms.com")
    JIMM_WSS_URL = os.environ.get("JIMM_WSS_URL", default="jimm.jujucharms.com:443")
    ...
    return flask.render_template(
        ...
        staticURL="/static",
        termsURL="https://"+JAAS_API_BASE+"/terms"), 200, {'Content-Type': 'text/javascript'}
