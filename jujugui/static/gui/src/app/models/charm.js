...
window.yui.add(
  ...
  function(Y) {
    ...
    models.Charm = Y.Base.create(
      ...
      [models.EntityExtension],
      {
        ...
        sync: function(action, options, callback) {
          if (action !== 'read') {
            throw 'Only use the "read" action; "' + action + '" not supported.';
          }
        ...
        compare: function(other, relevance, otherRelevance) {
          ...
          if (!owner && otherOwner) {
            ...
            return (
              this.get('package_name').localeCompare(other.get('package_name')) ||
    ...
    */
       ...
       */
                  ...
                  for (var i = 0; i < maxLength; i += 1) {
                    ...
                    if (segmentA === undefined) {
                      ...
                      var result =
                        ...
                        segmentA.localeCompare(segmentB, undefined, {
                          sensitivity: 'accent'
         ...
         */
            valueFn: function() {
              ...
              if (files.indexOf('icon.svg') !== -1 && this.get('is_approved')) {
                return true;
              } else {
                return false;
              }
     ...
     * @class CharmList
     */
    models.CharmList = Y.Base.create(
      'browserCharmList',
      Y.ModelList,
      [],
      {
