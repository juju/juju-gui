      ...
      <div className="expert-contact-card">
        <div className="expert-contact-card__initial">
          <ul className="expert-contact-card__highlights">
            {[
              <li className="expert-contact-card__highlight" key="Machine learning">
                <SvgIcon name="bullet" size="14" />
                Machine learning
              </li>,
              <li className="expert-contact-card__highlight" key="Data service deployments">
                <SvgIcon name="bullet" size="14" />
                Data service deployments
              </li>,
              <li className="expert-contact-card__highlight" key="Container orchestration">
                <SvgIcon name="bullet" size="14" />
                Container orchestration
              </li>
            ]}
          </ul>
          <Button action={wrapper.find('Button').prop('action')} type="positive">
        ...
        <ul className="expert-contact-card__contact-items">
          ...
          <li className="expert-contact-card__contact-item">
            ...
            <ul className="expert-contact-card__phone-numbers">
              {[
                <li className="expert-contact-card__phone-number" key="UK +44 (0)1603 327762">
                  UK +44 (0)1603 327762
                </li>,
                <li className="expert-contact-card__phone-number" key="US +1 8448141689">
                  US +1 8448141689
                </li>
              ]}
            </ul>
