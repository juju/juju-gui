...
class ISVProfile extends React.Component {
  ...
  */
  ...
  render() {
    return (
      <Panel instanceName="isv-profile" visible={true}>
          ...
          <div className="inner-wrapper">
            ...
            <main className="nine-col last-col">
              <div className="isv-profile__live-data clearfix">
                <h3 className="isv-profile__section-title">03 September 2016 - 14:35</h3>
                <div className="three-col isv-profile__box">
                  <h3 className="isv-profile__box-title">User this hour</h3>
                  <p className="isv-profile__box-stat">23</p>
                </div>
                <div className="three-col isv-profile__box">
                  <h3 className="isv-profile__box-title">Units this hour</h3>
                  <p className="isv-profile__box-stat">64</p>
                </div>
                <div className="three-col last-col isv-profile__box">
                  <h3 className="isv-profile__box-title">Net revenue to date</h3>
                  <p className="isv-profile__box-stat">$1,500.00</p>
                </div>
              </div>
              <div className="isv-profile__historic-data">
                <h3 className="isv-profile__section-title">Last six weeks</h3>
                <div className="twelve-col isv-profile__box">
                  <div className="twelve-col">
                    Show dates from:
                    <select className="isv-profile__historic-data-input" name="select">
                  ...
                  <div className="three-col last-col align-right">
                    <h3 className="isv-profile__box-title">Revenue</h3>
                    <p className="isv-profile__box-stat">$500.00</p>
                  </div>
                  <PlansUsage d3={this.props.d3} dataset={this.getDataSet()} />
                </div>
              </div>
            </main>
          </div>
