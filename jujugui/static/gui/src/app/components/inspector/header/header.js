  ...
  _generateLinks() {
    ...
    const getStarted = !this.props.hasGetStarted ? (
      ...
      <li className="inspector-header__list-item">
        <a onClick={this._navigateToGetStarted.bind(this)}>Get started</a>
      </li>
    );
    return (
      <ul className="inspector-header__inline-list">
        <li className="inspector-header__list-item">
          <a onClick={this._navigateToCharmDetails.bind(this)}>Charm details</a>
        </li>
        {getStarted}
      </ul>
    );
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        <span className="inspector-header__title">{this.props.title}</span>
        <span className="inspector-header__icon-container">
          <img className="inspector-header__service-icon" src={this.props.icon} />
        </span>
        {this._generateLinks()}
      </div>
    );
