      ...
      <div className="topology-canvas">
        <div className="environment-help" style={{display: 'none'}}>
          <div className="environment-help__content">
            <p className="environment-help__tooltip">Add a charm or bundle to get started</p>
            ...
            <svg
              className="environment-help__image"
              height="386.027"
            ...
            >
              <g className="plus-service">
                <circle cx="374.527" cy="96.438" fill="#FFF" r="63" stroke="#CECDCD" />
                <circle
                  className="plus-service__plus-circle"
                  cx="374.527"
                  cy="96.438"
                  fill="#38b44a"
                  r="32"
                />
                <path d="M383.527 95.438h-8v-8h-2v8h-8v2h8v8h2v-8h8" fill="#FFF" />
              </g>
              <g fill="none" stroke="#CECDCD">
                <circle cx="129.527" cy="300.771" r="63" />
                <circle cx="129.527" cy="300.771" r="32" strokeMiterlimit="10" />
              </g>
              <g fill="none" stroke="#CECDCD">
                <circle cx="679.295" cy="96.438" r="63" />
                <circle cx="679.295" cy="96.438" r="32" strokeMiterlimit="10" />
              </g>
              <path
                d="M438.046 96.438h178"
                fill="none"
                stroke="#CECDCD"
                strokeMiterlimit="10"
              />
              ...
              <path
                d="M175.28 257.708l150.865-120.865"
                fill="none"
                stroke="#CECDCD"
                strokeMiterlimit="10"
              />
        ...
        <div className="environment-menu" id="ambiguous-relation-menu">
          ...
          <div id="ambiguous-relation-menu-content" />
        </div>
