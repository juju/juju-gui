      ...
      <div className="payment__section">
        ...
        <div className="payment-details-view twelve-col">
          <div className="payment-details-fields">
            <GenericInput disabled={true} label="Name" value="Geoffrey Spinach" />
            <GenericInput disabled={true} label="Email address" value="spinach@example.com" />
            <GenericInput disabled={true} label="VAT number (optional)" value="1234" />
            <GenericInput disabled={true} label="Business name" value="Spinachy business" />
          </div>
          <h4>
            Addresses
            <Button
