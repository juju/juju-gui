...
class PaymentMethodCard extends React.Component {
  ...
  */
  _generateLogo() {
    ...
    return <SvgIcon name={`card-${brand}`} size="40" />;
  }
  ...
  */
  _generateActions() {
    ...
    return (
      <div className="payment-card-actions">
        <Button action={this.props.updatePaymentMethod} type="inline-neutral">
          Update payment details
        </Button>
        <Button action={this._removePaymentMethod.bind(this)} type="inline-neutral">
  ...
  render() {
    ...
    const cardClasses = classNames('payment-card-wrapper', {
    ...
    return (
      <div className="payment-card">
        <div className="five-col">
          <div className={cardClasses} onClick={this._handleCardClick.bind(this)}>
            <div className="payment-card-container">
              <div className="payment-card-front">
                <div className="payment-card-overlay" />
                <div className="payment-card-name">{card.cardHolder}</div>
              </div>
              <div className="payment-card-back">
                <div className="payment-card-overlay" />
                <div className="payment-card-number">xxxx xxxx xxxx {card.last4}</div>
                <div className="payment-card-bottom">
                  <div className="payment-card-expiry">
                    {card.month}/{card.year}
                  </div>
                  <div className="payment-card-brand">{this._generateLogo()}</div>
                </div>
              </div>
            </div>
          </div>
