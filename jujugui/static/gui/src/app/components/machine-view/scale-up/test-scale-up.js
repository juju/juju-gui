...
describe('MachineViewScaleUp', function() {
  ...
  it('can render', function() {
    ...
    const expected = (
      <form className="machine-view__scale-up" onSubmit={wrapper.prop('onSubmit')}>
        <ul className="machine-view__scale-up-units">
          <li className="machine-view__scale-up-unit" key="111111$">
            <img
              alt="django"
              className="machine-view__scale-up-unit-icon"
              src="data:image/gif;base64,"
            />
            <div className="machine-view__scale-up-unit-name" title="django">
              django
            </div>
            <input
          ...
          <li className="machine-view__scale-up-unit" key="222222$">
            <img
              alt="mysql"
              className="machine-view__scale-up-unit-icon"
              src="data:image/gif;base64,"
            />
            <div className="machine-view__scale-up-unit-name" title="mysql">
              mysql
            </div>
            <input
              className="machine-view__scale-up-unit-input"
