...
describe('ModelActions', function() {
    ...
    enzyme.shallow(
      <ModelActions
        ...
        displayTerminalButton={
          options.displayTerminalButton === undefined ? false : options.displayTerminalButton
        }
        ...
        loadingModel={options.loadingModel === undefined ? false : options.loadingModel}
        ...
        userIsAuthenticated={
          options.userIsAuthenticated === undefined ? true : options.userIsAuthenticated
        }
      />
    );
  ...
  it('can disable importing when read only', function() {
    ...
    const wrapper = renderComponent();
    assert.equal(wrapper.find('.model-actions__import').prop('onClick'), undefined);
  });
