...
module.exports = {
  spiculecharms: {
    logo: 'spicule.png',
    highlights: ['Machine learning', 'Data service deployments', 'Container orchestration'],
    contactDescription:
    ...
    storeDescription:
      'Learn how Spicule and Canonical can help solve your Big Data ' + 'challenges with JAAS:'
  },
  'tengu-team': {
    logo: 'tengu.png',
    highlights: [
