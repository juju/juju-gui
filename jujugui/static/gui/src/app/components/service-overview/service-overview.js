    ...
    */
    _generateActions: function(service) {
      ...
      actions.push({
        ...
        {
          title: 'Actions',
          icon: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="8" fill="#93A1A1" class="inspector-list__list-item-image"></circle></svg>'  // eslint-disable-line max-len
        },
        {
          title: 'Expose',
          value: 'Off',
