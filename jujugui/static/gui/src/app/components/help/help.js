...
${this.props.youtubeAPIKey}`,
  ...
  */
  ...
  _generateJujuShow() {
    ...
    return (
      <a
        ...
        target="_blank"
      >
        <img className="juju-show__image" src={this.state.jujuShow.thumbnail.url} />
        <p>
          <b>The Juju show</b>
          <span className="juju-show__title" title={this.state.jujuShow.title}>
  ...
  render() {
    ...
    return (
      <Lightbox close={this._handleClose.bind(this)} extraClasses={['help']}>
            ...
            <VanillaCard title="Getting started">
              <p>
                <a
                  ...
                  target="_blank"
                >
                  Read the {this.props.gisf ? 'JAAS' : 'Juju'} docs
                </a>
                .
              </p>
            </VanillaCard>
              ...
              <p>
                ...
                >
                  <img
                    ...
                    src={
                      'https://api.jujucharms.com/charmstore/v5/xenial/' +
            ...
            <VanillaCard title="Take a tour">
              <p>
                <img
                  ...
                  width="201"
                />
                <span className="link" onClick={this._startTour.bind(this)} role="button">
