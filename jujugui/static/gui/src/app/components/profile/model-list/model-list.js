        ...
        modelList.push({
          ...
          expandedContent: (
            <div className="profile-model-list__expanded-content">
              <div className="three-col">{nameContent}</div>
              <div className="two-col">{username}</div>
              <div className="three-col">{regionContent}</div>
              <div className="one-col">{accessContent}</div>
              <div className="two-col">{dateContent}</div>
              <div className="one-col last-col u-text-align--right">{destroyContent}</div>
              {expandedContent}
            </div>
          ),
          key: model.name
