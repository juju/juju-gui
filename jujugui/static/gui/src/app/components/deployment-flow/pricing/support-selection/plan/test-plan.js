      ...
      <div className="deployment-support-select-plan four-col">
        ...
        >
          ...
          <ul className="deployment-support-select-plan__features">
            <li className="deployment-support-select-plan__feature" key="feature 10">
              <SvgIcon name="bullet" size="14" />
              feature 1
            </li>
            <li className="deployment-support-select-plan__feature" key="feature 21">
              <SvgIcon name="bullet" size="14" />
              feature 2
            </li>
          </ul>
          <div className="deployment-support-select-plan__price">
            Monthly cost
            <span className="deployment-support-select-plan__price-number">${'3600.00'}</span>
          </div>
        </div>
