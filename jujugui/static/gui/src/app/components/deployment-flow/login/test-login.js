  ...
  const renderComponent = (options = {}) =>
    enzyme.shallow(
      <DeploymentLogin
        ...
        isDirectDeploy={options.isDirectDeploy === undefined ? false : options.isDirectDeploy}
        loginToController={options.loginToController || sinon.stub()}
        showLoginLinks={options.showLoginLinks === undefined ? true : options.showLoginLinks}
      />
    );
        ...
        <div className="deployment-login__features">
          <div className="six-col">
            <div className="deployment-login__feature">
              <SvgIcon className="deployment-login__tick" name="task-done_16" size="16" />
        ...
        <DeploymentSection instance="deployment-login-features">
          ...
          <div className="six-col last-col">
            <div className="deployment-login-features__logo">
              <SvgIcon height={53} name="aws-light" width={140} />
            </div>
            <div className="deployment-login-features__logo">
              <SvgIcon height={39} name="google-light" width={435} />
            </div>
            <div className="deployment-login-features__logo">
