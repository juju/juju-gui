    ...
    const expected = (
      <div className="deployment-signup">
        <div className="row border-bottom">
          ...
          <div className="six-col">
            <p className="intro">
              ...
              environment on your own machine. This minimises portability issues when deploying
              to a public cloud, OpenStack or bare metal.
            </p>
        ...
        <div className="row">
          ...
          <div className="six-col">
            <p>
              Coming soon: deploy from hosted Juju direct to public clouds. For early access to
              this feature, sign up for the beta.
            </p>
            <ul>
