...
YUI.add('changes-utils', function(Y) {
  ...
  /**
    ...
    @constructor
  */
  function ChangesUtils(cfg) {}

  ChangesUtils.prototype = {
    ...
    */
    generateAllChangeDescriptions: function(changeSet, services, units) {
      var changes = [],
          change;
    ...
    */
    generateChangeDescription: function(change, services, units, skipTime) {
      var changeItem = {};
    ...
    */
    getRealRelationEndpointNames: function(args, services) {
      var serviceList = [],
          serviceId;
    ...
    */
    getServiceByUnitId: function(unitId, services, units) {
