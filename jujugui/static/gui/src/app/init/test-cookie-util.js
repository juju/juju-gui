...
describe('CookieUtil', () => {
  ...
  it('calling check returns the notification', () => {
    ...
    const wrapper = enzyme.shallow(<div>{cookieUtil.check(fakeDocument, state)}</div>);
    const content = (
      <span>
        We use cookies to improve your experience. By your continued use of this application
        you accept such use. To change your settings please&nbsp;
