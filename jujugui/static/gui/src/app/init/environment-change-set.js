...
class EnvironmentChangeSet {
  ...
  */
  ...
  // */
  // _createNewRecord(type, command, parents) {
  ...
  // */
  // _placeIfNeeded(currLevel, keyToLevelMap, hierarchy, value, key) {
  ...
  //       if (!(model instanceof window.yui.Model)) {
  ...
  //   @param {Object} options The ECS options.
  // */
  // lazyAddPendingResources(args, options) {
  //   const command = {
  ...
  //   @param {Object} options The ECS options.
  // */
  // lazyImportSSHKeys(args, options) {
  //   const command = {
  //     method: '_importKeys',
  //     args: args,
  //     options: options
  ...
  //   @param {Object} options The ECS options.
  // */
  // lazyDestroyApplication(args, options) {
  //   var command = {
  ...
  // */
  // _destroyQueuedService(recordKey, record) {
  ...
  //   @param {Object} options The ECS options.
  // */
  // lazyDestroyMachines(args, options) {
  //   var command = {
  ...
  //   @param {Object} options The ECS options.
  // */
  // lazyRemoveRelation(args, options) {
  ...
  // */
  // validateUnitPlacement(unit, machineId, db) {
