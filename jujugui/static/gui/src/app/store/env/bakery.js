  ...
  var Bakery = Y.Base.create('Bakery',
      Y.Base, [], {
        ...
        /**
         ...
         @method initializer
         @param {Object} cfg A config object providing webhandler and visit
             method information. A visitMethod can be provided, which becomes
             the bakery's visitMethod. Alternatively, the bakery can be
             configured to non interactive mode. If neither is true, the default
             method is used.
        ...
        /**
         ...
         @return {Object} The asynchronous request instance.
        */
        sendPostRequest: function (path, data, successCallback,
                                   failureCallback) {
          var macaroons = this._getMacaroon();
          var headers = {
        ...
        /**
         ...
         response it will request authentication through the macaroon provided
         in the 401/407 response.
        ...
        /**
         Process the discharged macaroon and call the end point to be able to
         set a cookie for the origin domain only when an auth cookie path is
        ...
        _processDischarges: function (requestFunction, failureCallback,
          ...
          return this.webhandler.sendPutRequest(
            ...
            this._requestHandler.bind(
              this,
              this._setMacaroonsCookie.bind(this, requestFunction,
                  jsonMacaroon),
              failureCallback
            )
          );
