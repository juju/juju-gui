  ...
  */
   ...
   */
    ...
    */
        ...
        destructor: function() {
          document.removeEventListener('_rpc_response', this._handleRpcResponseBound);
        },
        ...
        _next: function() {
          this._send_rpc(
            ...
            function(data) {
              ...
              console.error('cannot get next changes from the mega-watcher:', data.error);
            }
          );
        },
    ...
    */
          ...
          if (typeof constraints === 'string') {
            ...
            constraints
              ...
              .forEach(function(constraint) {
                ...
                constraintsObj[constraintParts[0].trim()] = constraintParts[1].trim();
              });
        ...
        handleLogin: function(data) {
          ...
          if (this.userIsAuthenticated) {
            ...
            this.setConnectedAttr('modelId', tags.parse(tags.MODEL, response['model-tag']));
          ...
          } else if (!data.error || !utils.isRedirectError(data.error)) {
        ...
        currentModelInfo: function(callback) {
          ...
          var handler = data => {
            ...
            if (response['cloud-credential-tag']) {
              credential = tags.parse(tags.CREDENTIAL, response['cloud-credential-tag']);
            }
    ...
    */
      ...
      @param {Function} callback The callback to call after the file contents
        have been retrieved.
    */
        getLocalCharmFileContents: function(charmUrl, filename, progress, callback) {
    ...
    */
        _addPendingResources: function(args, callback) {
          ...
          if (!(args.applicationName && args.charmURL && resources && resources.length)) {
    ...
    */
        _destroyMachines: function(names, force, callback) {
          ...
          var intermediateCallback = null;
          if (callback) {
            intermediateCallback = this._handleDestroyMachines.bind(this, callback, names);
          }
          var request = {
            type: 'Client',
    ...
    */
      ...
      @return {undefined} Sends a message to the server only.
    */
        setCharm: function(applicationName, url, forceUnits, forceSeries, callback) {
          var args = {
            url: url,
      ...
      @method add_unit
    */
        add_unit: function(applicationName, numUnits, toMachine, callback, options) {
          if (options && options.immediate) {
            this._add_unit(applicationName, numUnits, toMachine, callback);
            return;
          }
          this.get('ecs').lazyAddUnits(
            [applicationName, numUnits, toMachine, callback],
            options
          );
        },
    ...
    */
        update_annotations: function(entity, type, data, callback, options) {
          ...
          this.get('ecs').lazyUpdateAnnotations([entity, type, data, callback], options);
        },
        ...
        set_config: function(applicationName, config, callback, options) {
          ...
          if (options && options.immediate) {
            ...
            if (ecs.changeSet[applicationName]) {
              throw new Error('You cannot immediately set config on a queued application');
            }
    ...
    */
        destroyApplication: function(applicationName, callback, options) {
          ...
          this.get('ecs').lazyDestroyApplication([applicationName, callback], options);
        },
    ...
    */
        resolved: function(unitName, relationName, retry, callback) {
          ...
          if (callback) {
            ...
            intermediateCallback = this.handleResolved.bind(null, callback, unitName);
          }
          this._send_rpc(
            {
              type: 'Client',
    ...
    */
        add_relation: function(endpointA, endpointB, callback, options) {
          ...
          this.get('ecs').lazyAddRelation([endpointA, endpointB, callback], options);
        },
    ...
    */
        remove_relation: function(endpointA, endpointB, callback, options) {
          ...
          this.get('ecs').lazyRemoveRelation([endpointA, endpointB, callback], options);
        },
    ...
    */
        addKeys: function(user, keys, callback, options) {
          ...
          this.get('ecs').lazyAddSSHKeys([user, keys, callback], options);
        },
    ...
    */
        importKeys: function(user, keys, callback, options) {
          ...
          this.get('ecs').lazyImportSSHKeys([user, keys, callback], options);
        },
            ...
            callback(null, {
              ...
              applications: objMap(resp.applications, app => ({
                ...
                canUpgradeTo: app['can-upgrade-to']
                  ? URL.fromLegacyString(app['can-upgrade-to'])
                  : null,
    ...
    */
        offer: function(applicationName, endpoints, url, users, description, callback) {
          ...
          // Define the API callback.
          var handleOffer = function(userCallback, applicationName, endpoints, url, data) {
            if (!userCallback) {
