// Copied from: https://github.com/survivejs/prism-languages/blob/master/index.js
// Changes noted below.

// XXX kadams54 27 Jan 2016 - Remove require calls as the libs are already loaded.
...
delete Prism.languages.haxe['class-name'];Prism.languages.nginx = Prism.languages.extend('clike', {
        'comment': {
                pattern: /(^|[^"{\\])#.*/,
                lookbehind: true
        },
...
}(Prism));Prism.languages.bison = Prism.languages.extend('c', {});
...
}, Prism.languages.parser['tag'].inside['attr-value']);Prism.languages.markdown = Prism.languages.extend('markup', {});
...
Prism.languages.markdown['italic'].inside['bold'] = Prism.util.clone(Prism.languages.markdown['bold']);(function(Prism) {
	// TODO:
...
Prism.languages.processing['class-name'].alias = 'variable';(function (Prism) {
...
Prism.languages.scss['atrule'].inside.rest = Prism.util.clone(Prism.languages.scss);/* TODO
...
}(Prism));// NOTES - follows first-first highlight method, block is locked after highlight, different from SyntaxHl
...
}(Prism));Prism.languages.brainfuck = {
	'pointer': {
		pattern: /<|>/,
		alias: 'keyword'
	},
...
Prism.languages.powershell.string[0].inside.function.inside = Prism.util.clone(Prism.languages.powershell);Prism.languages.prolog = {
...
// XXX kadams54 27 Jan 2016 Don't assign function to module.exports.
