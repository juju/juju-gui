...
-->
  ...
  <body>
    ...
    <script src="${convoy_url}?app/store/env/bakery.js&app/assets/javascripts/jujulib/index.js&app/assets/javascripts/jujulib/charmstore.js&app/assets/javascripts/jujulib/jimm.js"></script>
    % else:
    <!-- data-manual tells the Prism syntax highlighting lib to not auto-highlight -->
    ...
    <script src="${convoy_url}?app/store/env/bakery-min.js&app/assets/javascripts/jujulib/index-min.js&app/assets/javascripts/jujulib/charmstore-min.js&app/assets/javascripts/jujulib/jimm-min.js"></script>
    % endif
