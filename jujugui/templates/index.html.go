...
-->
  ...
  <body>
    ...
    <script src="{{.comboURL}}?app/assets/javascripts/prop-types.js&app/assets/javascripts/classnames.js"></script>
    ...
    <script src="{{.comboURL}}?app/assets/javascripts/prop-types.min.js&app/assets/javascripts/classnames-min.js"></script>
