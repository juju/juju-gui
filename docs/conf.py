...
project = u'JujuGUI'
copyright = u'2012-2013, Juju GUI Developers'
...
# Get the version from the CHANGES.yaml file in the project root.
changes_path = os.path.normpath(os.path.join(
    os.path.dirname(__file__), '..', 'CHANGES.yaml'))
version, release = get_version_from_changes(changes_path)
...
man_pages = [
    ('index', 'jujugui', u'JujuGUI Documentation',
     [u'Juju GUI Developers'], 1)
]
...
texinfo_documents = [
  ('index', 'JujuGUI', u'JujuGUI Documentation',
   u'Juju GUI Developers', 'JujuGUI', 'One line description of project.',
   'Miscellaneous'),
]
