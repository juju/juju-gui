...
describe('notifications', function () {
    ...
    it('must be able to track messages and levels', function () {
        ...
        nl.add([note1, note2]);
        nl.size().should.equal(2);
           nl.get_notice_levels().should.eql({
                                                 error: 1,
                                                 info: 1
                                             });
             ...
             it('must be able to get models for a given clientId',
               function() {
               var m = new models.Service({id: "mediawiki"}),
                   note1 = new models.Notification({
                               title: 'test1',
                               message: 'Hello',
                               model_id: m.get('clientId')
                   }),
                   note2 = new models.Notification({
                           title: 'test2',
                           message: 'I said goodnight!'
                   ...
                   nl.add([note1, note2]);
                   nl.size().should.equal(2);
                   nl.get_for_model(m).should.eql([note1]);
